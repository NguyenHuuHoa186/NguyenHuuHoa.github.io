...
from KNN_controller import send_ddos_alert_email
...
class SimpleMonitor13(switch.SimpleSwitch13):
    ...
    def send_ddos_alert_email(victim_ip):
        sender_email ="streetwear163@gmail.com"
        reciver_email = "2112979@dlu.edu.vn"
        password = "Hoa@2112979"

        message = MIMEMultipart()
        message["Subject"] = "Canh bao tan cong DDos"
        message["From"] = sender_email
        message["To"] = reciver_email

        text = f"""\
        Xin chào,
        Một cuộc tấn công DDoS tiềm năng đã được phát hiện.
        Địa chỉ IP của nạn nhân: {victim_ip}
        Vui lòng thực hiện các biện pháp cần thiết. """
    ...
    def flow_predict(self):
        try:
            ...
            if (legitimate_trafic/len(y_flow_pred)*100) > 80:
                ...
                send_ddos_alert_email(victim_ip=f"h{victim}")
